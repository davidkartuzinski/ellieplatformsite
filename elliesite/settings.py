"""
Django settings for elliesite project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'elliesite/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'elliesite.context_processors.global_vars',
            ],
        },
    },
]

WSGI_APPLICATION = 'elliesite.wsgi.application'
